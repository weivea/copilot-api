...
#
# Behavior:
#   - Stores everything under <release>/.certs/ (config, work, logs, live)
#   - On `obtain`, also writes <release>/copilot-api.config.json with the
...
CONFIG_FILE="$PROJECT_DIR/copilot-api.config.json"
